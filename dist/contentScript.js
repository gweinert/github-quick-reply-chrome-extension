...
define('contentScriptsApp/actions',{
	clickReply: 'click reply'
});
define('contentScriptsApp/utilities',{
...
define('contentScriptsApp/replyButtonSvg',{
	render: function() {		
		return (
...
define('contentScriptsApp/replyButton',['./actions', './utilities', './replyButtonSvg'], function(ACTIONS, utilities, ReplyButtonSvg) {
...
define('contentScriptsApp/replyInput',['./actions', './utilities'], function(ACTIONS, Utilities) {
